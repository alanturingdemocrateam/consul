...
with open("/Users/julian/democrateam/alan_turing/consul/lib/machine_learning/scripts/machine_learning_proposals_related_nmf.csv", mode="w") as csv_file:
...
with open("/Users/julian/democrateam/alan_turing/consul/lib/machine_learning/scripts/machine_learning_comments_textrank.csv", mode="w") as csv_file:
    csv_writer = csv.writer(csv_file, delimiter=";", quotechar='"', quoting=csv.QUOTE_MINIMAL)
...
with open("/Users/julian/democrateam/alan_turing/consul/lib/machine_learning/scripts/machine_learning_tags_nmf.csv", mode="w") as csv_file:
    csv_writer = csv.writer(csv_file, delimiter=";", quotechar='"', quoting=csv.QUOTE_MINIMAL)
...
with open("/Users/julian/democrateam/alan_turing/consul/lib/machine_learning/scripts/machine_learning_taggings_nmf.csv", mode="w") as csv_file:
    csv_writer = csv.writer(csv_file, delimiter=";", quotechar='"', quoting=csv.QUOTE_MINIMAL)
